...
public class EyesPart2 implements Runnable {

    private static final int drawingWidth = 800;
    private static final int drawingHeight = 800;
    ...
    public class DrawingPanel extends JPanel {
        ...
        ImageIcon kel = new ImageIcon("C:\\Java Workspace\\General\\src\\com\\pitstop\\learning\\Frames\\GUIExample\\timothy-kelley.jpg");
        Image back = kel.getImage();
